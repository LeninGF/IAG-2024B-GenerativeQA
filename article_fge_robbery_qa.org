...
#+LATEX_HEADER: \author{
#+LATEX_HEADER:     \IEEEauthorblockN{Lenin G. Falconí\textsuperscript{1}, Myriam Hernández-Alvarez\textsuperscript{2}, Lorena Isabel Barona López\textsuperscript{3} }\\
#+LATEX_HEADER:     \IEEEauthorblockA{\textsuperscript{1,2,3}Departmento de Informática y Ciencias de la Computación, Escuela Politécnica Nacional, Quito, Ecuador \\
#+LATEX_HEADER:                         Email: lenin.falconi@epn.edu.ec, myriam.hernandez@epn.edu.ec, lorena.barona@epn.edu.ec}
#+LATEX_HEADER: }


#+begin_comment
Colocar el nombre de Myriam al final en la version final de este articulo
#+end_comment
